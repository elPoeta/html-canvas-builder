...
export const CanvasView = ({
  ...
  const renderInteractiveWrapper = (
    ...
    // Don't wrap SVG/table elements - modify them directly
    if (svgChildTags.includes(v.tag) || tableElements.includes(v.tag)) {
      return element; // Return as-is, selection will be handled differently
    }

    // Use span for inline elements, div for block elements
    const WrapperTag = inlineElements.includes(v.tag) ? "span" : "div";
